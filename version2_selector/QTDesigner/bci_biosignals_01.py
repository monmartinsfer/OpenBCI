...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):                      #Recibe la pantalla de visualización DESDE GUI
        ...
        self.btn_trigger.setMinimumSize(QtCore.QSize(100, 17))
        self.btn_trigger.setMaximumSize(QtCore.QSize(100, 17))
        ...
        self.btn_connect.setMinimumSize(QtCore.QSize(100, 17))
        self.btn_connect.setMaximumSize(QtCore.QSize(100, 17))
        ...
        self.spinBox.setMaximumSize(QtCore.QSize(100, 17))
        ...
        self.btn_start.setMinimumSize(QtCore.QSize(100, 17))
        self.btn_start.setMaximumSize(QtCore.QSize(100, 17))
        ...
        self.controls_groupBox.setMinimumSize(QtCore.QSize(250, 16777215))
        self.controls_groupBox.setMaximumSize(QtCore.QSize(250, 16777215))
        ...
        self.windowsSize_formLayout.setContentsMargins(5, 6, 5, 6)          #Fija los márgenes izq, dch, sup e inf
        self.windowsSize_formLayout.setVerticalSpacing(10)                  #Fija el espaciado entre elementos
        self.windowsSize_formLayout.setHorizontalSpacing(6)
        ...
        self.channels_comboBox.setMaximumSize(QtCore.QSize(200, 17))
        #self.channels_comboBox.lineEdit().setAlignment(QtCore.Qt.AlignCenter)
        ...
        self.butterOrder_spinBox.setMaximumSize(QtCore.QSize(200, 17))
        self.butterOrder_spinBox.setAlignment(QtCore.Qt.AlignCenter)
        ...
        self.WindowsSize_spinBox.setMaximumSize(QtCore.QSize(100, 17))
        self.WindowsSize_spinBox.setAlignment(QtCore.Qt.AlignCenter)
        ...
        self.frequency_comboBox.setMaximumSize(QtCore.QSize(100, 17))
        #self.frequency_comboBox.lineEdit().setAlignment(QtCore.Qt.AlignCenter)
        ...
        self.filtering_comboBox.setMaximumSize(QtCore.QSize(100, 17))
        #self.filtering_comboBox.lineEdit().setAlignment(QtCore.Qt.AlignCenter)
        ...
        self.Spectrogram_comboBox.setMaximumSize(QtCore.QSize(50, 17))
        #self.channels_comboBox.setAlignment(QtCore.Qt.AlignCenter)
        self.controls_horizontalLayout.addWidget(self.Spectrogram_comboBox)

        self.channels_grid = QtWidgets.QGridLayout()
        self.channels_grid.setObjectName("channels_gridBox")
        self.channels_grid.setVerticalSpacing(5)
        self.channels_grid.setHorizontalSpacing(1)

        self.F1_checkBox = QtWidgets.QCheckBox(self.controls_groupBox)
        self.F1_checkBox.setObjectName("F1_radioButton")
        self.channels_grid.addWidget(self.F1_checkBox, 0, 0, 1, 1)

        self.F2_checkBox = QtWidgets.QCheckBox(self.controls_groupBox)
        self.F2_checkBox.setObjectName("F2_radioButton")
        self.channels_grid.addWidget(self.F2_checkBox, 1, 0, 1, 1)

        self.C3_checkBox = QtWidgets.QCheckBox(self.controls_groupBox)
        self.C3_checkBox.setObjectName("C3_radioButton")
        self.channels_grid.addWidget(self.C3_checkBox, 2, 0, 1, 1)

        self.C4_checkBox = QtWidgets.QCheckBox(self.controls_groupBox)
        self.C4_checkBox.setObjectName("C4_radioButton")
        self.channels_grid.addWidget(self.C4_checkBox, 3, 0, 1, 1)

        self.P7_checkBox = QtWidgets.QCheckBox(self.controls_groupBox)
        self.P7_checkBox.setObjectName("P7_radioButton")
        self.channels_grid.addWidget(self.P7_checkBox, 4, 0, 1, 1)

        self.P8_checkBox = QtWidgets.QCheckBox(self.controls_groupBox)
        self.P8_checkBox.setObjectName("P8_radioButton")
        self.channels_grid.addWidget(self.P8_checkBox, 5, 0, 1, 1)

        self.O1_checkBox = QtWidgets.QCheckBox(self.controls_groupBox)
        self.O1_checkBox.setObjectName("O1_radioButton")
        self.channels_grid.addWidget(self.O1_checkBox, 6, 0, 1, 1)

        self.O2_checkBox = QtWidgets.QCheckBox(self.controls_groupBox)
        self.O2_checkBox.setObjectName("O2_radioButton")
        self.channels_grid.addWidget(self.O2_checkBox, 7, 0, 1, 1)

        self.F7_checkBox = QtWidgets.QCheckBox(self.controls_groupBox)
        self.F7_checkBox.setObjectName("F7_radioButton")
        self.channels_grid.addWidget(self.F7_checkBox, 0, 1, 1, 1)

        self.F8_checkBox = QtWidgets.QCheckBox(self.controls_groupBox)
        self.F8_checkBox.setObjectName("F8_radioButton")
        self.channels_grid.addWidget(self.F8_checkBox, 1, 1, 1, 1)

        self.F3_checkBox = QtWidgets.QCheckBox(self.controls_groupBox)
        self.F3_checkBox.setObjectName("F3_radioButton")
        self.channels_grid.addWidget(self.F3_checkBox, 2, 1, 1, 1)

        self.F4_checkBox = QtWidgets.QCheckBox(self.controls_groupBox)
        self.F4_checkBox.setObjectName("F4_radioButton")
        self.channels_grid.addWidget(self.F4_checkBox, 3, 1, 1, 1)

        self.T7_checkBox = QtWidgets.QCheckBox(self.controls_groupBox)
        self.T7_checkBox.setObjectName("T7_radioButton")
        self.channels_grid.addWidget(self.T7_checkBox, 4, 1, 1, 1)

        self.T8_checkBox = QtWidgets.QCheckBox(self.controls_groupBox)
        self.T8_checkBox.setObjectName("T8_radioButton")
        self.channels_grid.addWidget(self.T8_checkBox, 5, 1, 1, 1)

        self.P3_checkBox = QtWidgets.QCheckBox(self.controls_groupBox)
        self.P3_checkBox.setObjectName("P3_radioButton")
        self.channels_grid.addWidget(self.P3_checkBox, 6, 1, 1, 1)

        self.P4_checkBox = QtWidgets.QCheckBox(self.controls_groupBox)
        self.P4_checkBox.setObjectName("P4_radioButton")
        self.channels_grid.addWidget(self.P4_checkBox, 7, 1, 1, 1)

        self.channels_checkBox_list = [self.F1_checkBox, self.F2_checkBox, self.C3_checkBox, self.C4_checkBox, self.P7_checkBox,
                                  self.P8_checkBox, self.O1_checkBox, self.O2_checkBox, self.F7_checkBox, self.F8_checkBox,
                                  self.F3_checkBox, self.F4_checkBox, self.T7_checkBox, self.T8_checkBox, self.P3_checkBox,
                                  self.P4_checkBox]

        self.verticalLayout_3.addLayout(self.controls_horizontalLayout)
        self.verticalLayout_5.addWidget(self.controls_groupBox)
        self.verticalLayout_5.addLayout(self.channels_grid)

        self.log_groupBox = QtWidgets.QGroupBox(self.centralwidget)
        self.log_groupBox.setMinimumSize(QtCore.QSize(250, 200))
        self.log_groupBox.setMaximumSize(QtCore.QSize(250, 200))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.WindowsSize_label.setText(_translate("MainWindow", "Windows size [sec]"))
        ...
        self.F1_checkBox.setText(_translate("MainWindow", "F1"))
        self.F1_checkBox.setStyleSheet("background: red")
        self.F2_checkBox.setText(_translate("MainWindow", "F2"))
        self.F3_checkBox.setText(_translate("MainWindow", "F3"))
        self.F4_checkBox.setText(_translate("MainWindow", "F4"))
        self.F7_checkBox.setText(_translate("MainWindow", "F7"))
        self.F8_checkBox.setText(_translate("MainWindow", "F8"))
        self.C3_checkBox.setText(_translate("MainWindow", "C3"))
        self.C4_checkBox.setText(_translate("MainWindow", "C4"))
        self.T7_checkBox.setText(_translate("MainWindow", "T7"))
        self.T8_checkBox.setText(_translate("MainWindow", "T8"))
        self.P3_checkBox.setText(_translate("MainWindow", "P3"))
        self.P4_checkBox.setText(_translate("MainWindow", "P4"))
        self.P7_checkBox.setText(_translate("MainWindow", "P7"))
        self.P8_checkBox.setText(_translate("MainWindow", "P8"))
        self.O1_checkBox.setText(_translate("MainWindow", "O1"))
        self.O2_checkBox.setText(_translate("MainWindow", "O2"))
